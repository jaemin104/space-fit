...
export default function VoiceOrderPreferences({ onBack, onComplete }: { onBack: () => void; onComplete: (preferences: OrderPreferences, transcript: string) => void }) {
  ...
  return <div className="voice-order-screen">
    ...
    <header><button type="button" onClick={onBack} aria-label="홈으로 돌아가기">‹</button><span>오늘의 운행 목표</span></header>
    <main>
